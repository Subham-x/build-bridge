...
pub fn themed_icon(dark: bool, icon: IconKind) -> ImageSource<'static> {
    match (dark, icon) {
        ...
        (true, IconKind::Refresh) => egui::include_image!("../assets/icons/redresh_dark.svg"),
        (false, IconKind::Refresh) => egui::include_image!("../assets/icons/redresh_light.svg"),
        (true, IconKind::Info) => egui::include_image!("../assets/icons/info_dark.svg"),
        (false, IconKind::Info) => egui::include_image!("../assets/icons/info_light.svg"),
